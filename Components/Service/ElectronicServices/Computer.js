...
const Computer = () => {
      ...
      ComputerService: [
         {
            ...
            longitude: 70.212965,
            price: 500,
            serviceName: "Techie Computer Service",
            ...
            loyaltyProgram: "Free system checkup on every 5th service",
            reviews: [
               {
                  customer: "Rahul Sharma",
                  rating: 4.5,
                  comment: "Quick and reliable computer repair.",
               },
               {
                  customer: "Priya Patel",
                  rating: 4.7,
                  comment: "Fixed my laptop in no time.",
               },
            ],
            rating: 4.6,
         },
      ...
      ComputerRepair: [
         {
            ...
            reviews: [
               ...
               },
               {
                  ...
                  rating: 4.3,
                  comment: "Fixed my laptop efficiently.",
               },
            ],
            rating: 4.6,
         },
         {
            ...
            longitude: 70.315875,
            price: 450,
            serviceName: "QuickFix Computers",
            ...
            reviews: [
               ...
               },
               {
                  customer: "Arun Gupta",
                  rating: 4.7,
                  comment: "Solved my laptop’s overheating issue.",
               },
            ],
            rating: 4.8,
         },
      ...
      ComputerInstallation: [
         {
            ...
            longitude: 70.2670,
            price: 700,
            serviceName: "Expert Tech Installers",
            ...
            loyaltyProgram: "Free setup check after 6 months",
            reviews: [
               {
                  customer: "Suresh Verma",
                  rating: 4.9,
                  comment: "Thorough and efficient installation.",
               },
               {
         ...
         },
         {
            ...
            longitude: 71.295975,
            price: 750,
            serviceName: "Precision PC Installation",
            ...
            loyaltyProgram: "Discounted service for referrals",
            reviews: [
               {
                  customer: "Ravi Kumar",
                  rating: 4.8,
                  comment: "Quick and professional setup.",
               },
               {
   ...
   const testimonialData = [
      {
         id: 1,
         text: "Excellent service! My Computer was repaired within an hour. Highly recommend!",
         author: "John Doe",
      },
      {
         id: 2,
      ...
      {
         id: 3,
         text: "Great experience! My Computer was fixed on the spot, and the customer service was top-notch.",
   ...
   const serviceData = [
      {
         ...
         image: require("../../../img/desktopcomputer1.jpg"),
      },
      {
         id: 2,
         title: "Computer Repair",
         price: "Quick Fixes",
         image: require("../../../img/desktopcomputer2.jpg"),
      ...
      },
      {
         ...
         image: require("../../../img/desktopcomputer3.jpg"),
   ...
   const handleclick = (item) => {
      console.log(item.id)
      if (item.id === 1) {
         navigation.navigate('BookingScreen', { type: 'ComputerService', data: data.ComputerService });
      } if (item.id === 2) {
         navigation.navigate('BookingScreen', { type: 'ComputerRepair', data: data.ComputerRepair });
      } if (item.id === 3) {
   ...
   return (
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false} >
         ...
         <View style={styles.videoContainer}>
            <Video
               source={require("../../../video/Computer.mp4")} // Replace with your video URL
               style={styles.video}
               resizeMode="cover"
               useNativeControls
               isLooping
         ...
         <View style={styles.titleSection}>
            <Text style={styles.title}>Computer Repair & Service</Text>
         ...
         <View style={styles.footer}>
            <Text style={styles.footerText}>© 2025 Computer Services. All Rights Reserved.</Text>
         </View>
